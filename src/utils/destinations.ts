...
export const findDestinationInMapData = (filteredMapData?: TMapElement[], destination?: TDestination) => filteredMapData?.find((element) => element.name === destination?.name || element.id === destination?.name);
